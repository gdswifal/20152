...
<div class="col-md-6">
    <div class="col-md-6">
        <a class="btn btn-info linkAjax img-rounded" href="admin.php"><span class="glyphicon glyphicon-refresh"></span></a>
        <a class="btn btn-primary" role="button" data-toggle="modal" data-target="#atualizarDados">Editar</a>
    </div>
    <div class="col-md-6">
        <img src="../../images/companyLogos/<?php echo $_SESSION['photo'] ?>" alt="<?php echo $_SESSION['name'] ?>" class="img-thumbnail">
    </div>
